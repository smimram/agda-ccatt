...
This is done by implementing polygraphs (in low dimensions) as a nice type-theoretic structure where pasting schemes are already substituted (there are no explicit substitutions). However, we do not seem to be able to express coherences as we want.
